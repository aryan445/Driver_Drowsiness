...
predictor = dlib.shape_predictor(r"C:\Driver_Drowsisness\shape_predictor_68_face_landmarks.dat")
...
def main():
	cap = cv2.VideoCapture(r"C:\Users\DELL\Pictures\Camera Roll\WIN_20230715_09_25_36_Pro.mp4")
	sleep = 0
	drowsy = 0
	active = 0
	status=""
		...
		for face in faces:
			...
			if(left_blink==0 or right_blink==0):
				...
				if(sleep>6):
						...
						color = (255,0,0)
						mixer.init()
						mixer.music.load(r"C:\Driver_Drowsisness\sound\warning.mpeg")
				...
				if(drowsy>6):
						...
						color = (0,0,255)
						mixer.init()
						mixer.music.load(r"C:\Driver_Drowsisness\sound\warning_yawn.mpeg")
						mixer.music.play()
						while mixer.music.get_busy():  
							time.sleep(1)
			else:
